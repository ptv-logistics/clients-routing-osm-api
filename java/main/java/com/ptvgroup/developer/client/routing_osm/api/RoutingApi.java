...
public class RoutingApi {
   ...
   * @param profile A profile defines a vehicle by a set of attributes, matching typical transport situations. It must be the name of one of the predefined profiles such as _BICYCLE_OSM_. (optional, default to BICYCLE_OSM)
